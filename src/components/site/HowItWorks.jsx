...
const steps = [
  {
    icon: Mic,
    title: "Capture",
    desc: "Beamforming mics isolate the speaker's voice.",
  },
  {
    icon: Brain,
    title: "Understand",
    desc: "On-device AI converts speech to text & emotion.",
  },
  {
    icon: Glasses,
    title: "See",
    desc: "Subtitles + emojis project on the AR lens.",
  },
];

export const HowItWorks = () => (
  <section id="how" className="py-24 relative bg-black">
    <div className="container-pad">
      <SectionHeader
        eyebrow="How it works"
        title={
          <>
            From sound to <span className="gradient-text">sight</span> in
            milliseconds
          </>
        }
      />
